...
contract CardRoomLeaderboardV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    struct PlayerStats {
        uint32 wins;
        uint32 losses;
    ...
    function recordSoloResult(uint8 gameId, bool won, uint8 cardsRemaining) external {
        require(gameId <= soloGameMax, "Not a solo game");
    ...
    function recordVsAiResult(uint8 gameId, bool won) external {
        require(gameId > soloGameMax && gameId < gameCount, "Not a vs-AI game");

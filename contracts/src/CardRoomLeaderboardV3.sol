...
contract CardRoomLeaderboardV3 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    struct PlayerStats {
        uint32 wins;
        uint32 losses;
    ...
    uint8 public soloGameMax; // deprecated — kept for storage layout compatibility
